...
/** Route fields and stop objects are sibling JSON keys, so this DTO needs a custom serializer. */
...
/** Separates fixed route fields from dynamically named stop objects and reverses that when encoding. */
