...
import edu.rpi.shuttletracker.data.local.preferences.DataStoreUserPreferences
...
abstract class PreferencesModule {
    @Binds
    @Singleton
    abstract fun bindUserPreferences(implementation: DataStoreUserPreferences): UserPreferences
